...
export default function Home() {
  return (
    <div
      id="home"
      className="flex flex-col justify-center items-center md:max-w-[1200px] w-full mx-auto lg:flex-row md:justify-between gap-10 sm:gap-3"
    >
      <div className="flex flex-col justify-center items-center md:items-start md:gap-6 gap-6 mx-3">
        <h1 className="font-bold text-5xl md:text-start lg:text-6xl">
          Full Stack Developer
        </h1>
        <p className="text-2xl md:text-start">
          Scalable. Reliable. Built for the Future.
        </p>
        <div>
